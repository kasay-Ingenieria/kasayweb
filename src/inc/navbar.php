    ...
    <header class="bg-white shadow-md fixed w-full z-50">
        <nav class="container mx-auto px-16 py-4 flex items-center justify-between">
            ...
            <div id="menu"
                ...
                <a href="/kasayweb/src/views/contacto.php"
                    class="block text-gray-600 hover:text-blue-500 transition duration-300 py-2 md:py-0">Contacto</a>
                <a href="/kasayweb/src/views/login.php"
                    class="block text-center bg-[linear-gradient(120deg,_rgba(0,124,240,0.9),_rgba(0,154,186,0.8))] text-white px-4 py-2 rounded-full hover:bg-blue-500 transition duration-300 mt-2 md:mt-0">Iniciar
                    sesión</a>
            </div>
        </nav>
    </header>
