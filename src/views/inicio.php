...
?>
    ...
    <div class="relative z-20 flex items-center justify-center h-full text-white text-3xl">
        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <a href="src/views/inicio.php#servicios" class="bg-white text-blue-500 font-bold py-3 px-8 rounded-full hover:bg-gray-200 transition duration-300 text-lg">Descubre Más</a>
        </div>
