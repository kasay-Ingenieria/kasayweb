...
?>
    ...
    <section id="inicio" class="text-white pt-3 md:pt-16 pb-0">
        ...
        <div class="relative w-full h-[70vh] md:h-[50vh] overflow-hidden">
            ...
            <!-- Texto alternativo para accesibilidad, se usa para los lectores de pantalla jejej -->
            <span class="sr-only">Video de fondo ilustrando tecnología catastral en acción.</span>
    ...
    <section class="text-sky-700 mx-auto pt-20 pb-10 bg-white">
        <div class="container mx-auto  text-justify pb-10 px-4 sm:px-8 md:px-24 lg:px-48">
            ...
            <p class="text-lg md:text-xl mb-8 max-w-6xl ">
                Somos una empresa especializada en sistemas de información geográfica (SIG) y servicios de georreferenciación, conformada por un equipo multidisciplinario de expertos en tecnología geodésica, cartografía y sistemas de información.
                Nos enfocamos en brindar soluciones geoespaciales que permitan a las organizaciones tomar decisiones estratégicas basadas en datos precisos, actualizados en tiempo real. Nuestra misión es transformar la información geográfica en conocimiento útil, aplicando tecnología de vanguardia para maximizar el valor de los datos espaciales.
            </p>
        </div>
...
<section id="servicios" class="py-6 px-4 sm:px-10 md:px-20 bg-sky-50">
    ...
    <div class="grid md:grid-cols-2 gap-10 md:gap-40 items-center">
      ...
      <div class="bg-sky-50 w-full max-w-4xl p-6 md:p-8 rounded-lg mx-auto md:ml-20">
        <p class="text-sky-600 text-2xl sm:text-3xl md:text-4xl text-center font-lora leading-relaxed">
          ❝ En Kasay Ingeniería S.A.S., nuestra misión y visión reflejan nuestro compromiso con la tecnología, el territorio y el desarrollo sostenible. ❞
        </p>  
      </div>
 ...
 <section id="servicios" class="py-24  bg-white ">
            <div class="container mx-auto grid md:grid-cols-7 gap-12 justify-center items-start px4 ">
                ...
                <div class="bg-white h-full border-2 border-sky-50  max-w-7xl col-span-2 p-6 rounded-lg hover:shadow-xl transition-shadow duration-300">                
                ...
                <div class="bg-white h-full border-2 border-sky-50 p-6 col-span-5 rounded-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center justify-center mb-8">    
                        <h3 class="text-sky-700 text-3xl font-semibold text-center">
...
A través de la innovación, la precisión y un firme compromiso con la excelencia, apoyamos a los municipios en su habilitación como Gestores Catastrales, optimizamos procesos de toma de decisiones georreferenciadas y mejoramos la eficiencia operativa mediante herramientas de seguimiento vehicular en tiempo real y planificación inteligente de rutas. Nuestras plataformas SIG web y soluciones SaaS ofrecen herramientas escalables y accesibles para una gestión territorial moderna y efectiva.

Colaboramos estrechamente con nuestros clientes, entendiendo sus desafíos geográficos y administrativos particulares para entregar estrategias a la medida, que generen decisiones informadas e impactos medibles. Con integridad, excelencia técnica y una visión centrada en el desarrollo sostenible, estamos comprometidos con liderar el futuro de la inteligencia geoespacial y contribuir a la transformación digital de los territorios en América Latina y el mundo.</p>
                     </div>   
                </div>         
    </section>
