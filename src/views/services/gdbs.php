...
<html lang="es">
    ...
    <body class="bg-gray-100 text-gray-800">
        ...
        <?php 
        // Nota: La capacidad de respuesta de la barra de navegación depende del código en 'navbar.php'.
        // Se asume que este archivo ya contiene un diseño adaptable (por ejemplo, un menú de hamburguesa).
        ...
        <section id="inicio" class="text-white">
            <div class="relative w-full h-[650px] md:h-[550px] overflow-auto">
                ...
                <div class="relative z-20 flex items-center justify-center h-full md:h-[400px]">
                    <div class="container mx-auto pt-32 md:pt-52 text-center" data-aos="fade-down">
                        <h1 class="text-4xl md:text-6xl font-bold mb-6 sm:pt-20 leading-tight">  Bases de Datos Geográficas 
                        </h1>
                        <p class="text-lg md:text-2xl mb-8 max-w-2xl mx-auto text-center font-lora"> Diseñamos, implementamos y gestionamos bases de datos espaciales robustas para potenciar su sistema de información geográfica.
                        </p>                        
                        <!-- Sección inferior con 3 bloques -->
                        <div class="hidden xl:grid  mt-16 grid-cols-3">

                            <!-- Bloque Servicios -->
                            <div class="text-left text-base sm:text-sm mx-auto hover:text-white max-w-xs">
                                <a href="#seccion_carrusel">
                                <p><i class="fa-solid fa-gear mr-2"></i> Servicios</p>
                                <hr class="border-t-2 border-gray-300 my-2">
                                <p>Descubre cómo diseñamos, implementamos y administramos bases de datos espaciales.</p>
                                </a>
                            </div>
                            ...
                            <div class="text-left text-base sm:text-sm mx-auto hover:text-white max-w-xs">
                                ...
                                <p><i class="fa-solid fa-suitcase mr-2"></i> Tecnologías</p>
                                <hr class="border-t-2 border-gray-300 my-2">
        ...
        <section id="solucion" class="py-16 bg-white [scroll-margin-top:80px]"> <div class="container mx-auto px-6"data-aos="fade-up">
                <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-sky-800">
                    La Infraestructura de Datos para su Territorio </h2>
                <div class="max-w-5xl mx-auto text-center text-lg leading-relaxed text-gray-700">
                    ...
                    <p>
                    Nuestras soluciones aseguran que su información geográfica sea accesible, segura, actualizada y estructurada de manera óptima para soportar sus necesidades de análisis, visualización y toma de decisiones. </p>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-blue-50">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-sky-800 "data-aos="fade-up">
                    Beneficios de Contar con Bases de Datos Geográficas Robustas </h2>
        ...
        <hr/> <section id="servicios" class="py-16 bg-white [scroll-margin-top:100px]">
            <div class="container mx-auto px-8" >
                <h2 class="text-3xl md:text-4xl font-bold text-center mb-20 text-sky-800 " data-aos="fade-up">
                    Nuestros Servicios en Bases de Datos Geográficas </h2>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div class="flex items-start bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex-shrink-0 text-sky-600 text-3xl mr-4">
                    ...
                    <div class="flex items-start bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="300">
                        <div class="flex-shrink-0 text-sky-600 text-3xl mr-4">
        ...
        <hr/> <section id="tecnologias" class="py-16 bg-white [scroll-margin-top:200px]">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-sky-800" data-aos="fade-up">
        ...
        <section id="proceso" class="py-16 bg-blue-50 [scroll-margin-top:50px]">
            <div class="container mx-auto px-6">
                ...
                <div class="relative max-w-4xl mx-auto">
                    <div class="absolute top-0 h-full w-0 sm:w-0.5 bg-sky-300 left-6 md:left-1/2 transform md:-translate-x-1/2"></div>
                    
                    <div class="space-y-12 md:space-y-0">
                        
                        <div class="md:flex md:items-center md:justify-normal" data-aos="fade-right">
                            <div class="md:w-1/2"></div>
                            <div class="hidden md:block z-10 bg-sky-500 text-white w-12 h-12 pt-2 pl-4 rounded-full items-center justify-center font-bold text-xl relative">1</div>
                            <div class="md:w-1/2 md:pl-10">
                                <div class="relative">
                                    <div class="sm:ml-12 md:ml-0 bg-white p-6 rounded-lg shadow-md card-hover-effect">
                        ...
                        <div class="md:flex md:items-center md:justify-normal md:flex-row-reverse" data-aos="fade-left">
                            <div class="md:w-1/2"></div>
                            <div class="hidden md:block z-10 bg-sky-500 text-white w-12 h-12 rounded-full pt-2 pl-4 items-center justify-center font-bold text-xl relative">2</div>
                        ...
                        <div class="md:flex md:items-center md:justify-normal" data-aos="fade-right">
                             <div class="md:w-1/2"></div>
                            <div class="hidden md:block z-10 bg-sky-500 text-white w-12 h-12 rounded-full pt-2 pl-4 items-center justify-center font-bold text-xl relative">3</div>
                            <div class="md:w-1/2 md:pl-10">
                                <div class="relative">
                                    <div class="sm:ml-12 md:ml-0 bg-white p-6 rounded-lg shadow-md card-hover-effect">
                        ...
                        <div class="md:flex md:items-center md:justify-normal md:flex-row-reverse" data-aos="fade-left">
                            <div class="md:w-1/2"></div>
                             <div class="hidden md:block z-10 bg-sky-500 text-white w-12 h-12 rounded-full pt-2 pl-4 items-center justify-center font-bold text-xl relative">4</div>
                            <div class="md:w-1/2 md:pr-10">
                                <div class="relative">
                                    <div class="sm:ml-12 md:ml-0 bg-white p-6 rounded-lg shadow-md card-hover-effect">
        ...
        <hr/> <section class="py-16 bg-white">
        ...
        <hr/> <script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js" defer></script> <script>
            // Inicializa la librería AOS para las animaciones en scroll
            AOS.init({
                duration: 800, // Duración de la animación en milisegundos
                once: true, // La animación solo ocurre una vez para mejorar el rendimiento
            });
        </script>
