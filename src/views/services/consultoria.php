    ...
    <section id="inicio" class="relative w-full h-screen overflow-hidden text-white">
        ...
        <div class="relative z-20 flex flex-col items-center justify-center h-full text-center px-6">
            <div data-aos="fade-down">
                <h1 class="text-3xl sm:text-3xl md:text-6xl font-bold mb-6 leading-tight">
                ...
                <a href="#hoja-de-ruta" class="bg-sky-600 text-white font-bold py-3 px-8 rounded-full hover:bg-sky-700 transition duration-300 text-sm sm:text-lg shadow-lg">
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                ...
                <div class="md:order-1 " data-aos="fade-right">
                    ...
                    <p class="text-lg text-gray-600 text-justify sm:px-0 px-4 hyphens-auto mb-4">
                    ...
                    <p class="text-lg text-gray-600 text-justify sm:px-0 px-4 hyphens-auto">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white p-6 md:p-8 rounded-lg text-center border-t-4 border-sky-500 shadow-lg" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800">Habilitación Tecnológica</h3>
                    <p class="text-gray-600">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="relative max-w-4xl mx-auto">
                ...
                <div class="mb-12 flex flex-wrap justify-center md:justify-between items-center w-full" data-aos="fade-right">
                    ...
                    <div class="w-full md:w-2/5 bg-white p-6 rounded-lg shadow-md timeline-card mt-4 md:mt-0 order-2 md:order-3">
                ...
                <div class="mb-12 flex flex-wrap justify-center md:justify-between items-center w-full" data-aos="fade-right">
                    <div class="w-2/5 hidden md:block"></div>
                    <div class="z-10 bg-sky-600 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl shadow-lg order-1 md:order-2">3</div>
                    <div class="w-full md:w-2/5 bg-white p-6 rounded-lg shadow-md timeline-card mt-4 md:mt-0 order-2 md:order-3">
