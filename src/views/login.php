            ...
            <div id="login-card"
                ...
                <form action="src/inc/process_login.php" method="POST" class="space-y-6">
                    ...
                    <div class="text-center mt-4">
                        <a href="#"
                            class="inline-block align-baseline font-semibold text-sm text-sky-600 hover:text-sky-800 hover:underline transition duration-200">
                            ¿Olvidó su contraseña?
                        </a>
                    </div>
                </form>
                <!-- Pie de página de el login -->
